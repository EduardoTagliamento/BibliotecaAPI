...
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('1', 'Alice no País das Maravilhas', '1864-11-26', '3', '10');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('2', 'O Chamado de Cthulu', '1928-02-01', '1', '9');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('3', 'O Senhor dos Anéis', '1954-07-29', '2', '10');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('4', 'Dom Casmurro', '1899-01-01', '4', '4');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('5', 'Iracema', '1865-01-01', '5', '4');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('6', 'Arsène Lupin contra Herlock Sholmès', '1910-01-01', '6', '5');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('7', 'Dom Quixote de la Mancha', '1605-01-01', '7', '4');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('8', 'Hamlet', '1623-01-01', '8', '3');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('9', 'O Fantástico Homem-Aranha', '2012-07-06', '9', '5');
INSERT INTO `Biblioteca`.`Livros` (`idLivro`, `nomeLivro`, `dataLancamento`, `idAutor`, `idCategoria`) VALUES ('10', 'Morro dos Ventos Uivantes', '1847-11-24', '10', '4');